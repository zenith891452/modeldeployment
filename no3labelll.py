...
try:
    ...
    booking_status_encode = joblib.load('b/content/booking_status_encode.pkl')
...
# Helper: Prediksi dan tampilkan hasil
...
if st.button("📦 Jalankan Testcase 1"):
    testcase1 = {
        ...
        'lead_time': 30, 'arrival_year': 2018, 'arrival_month': 6, 'arrival_date': 12,
        'repeated_guest': 0, 'no_of_previous_cancellations': 0, 'no_of_previous_bookings_not_canceled': 0,
        'avg_price_per_room': 90.0, 'no_of_special_requests': 1,
        ...
        'market_segment_type_Corporate': 1, 'market_segment_type_Offline': 0,
...
if st.button("📦 Jalankan Testcase 2"):
    testcase2 = {
        ...
        'lead_time': 120, 'arrival_year': 2018, 'arrival_month': 10, 'arrival_date': 5,
        'repeated_guest': 1, 'no_of_previous_cancellations': 1, 'no_of_previous_bookings_not_canceled': 3,
        'avg_price_per_room': 150.0, 'no_of_special_requests': 0,
        'type_of_meal_plan_Meal Plan 1': 0, 'type_of_meal_plan_Meal Plan 2': 1,
        'type_of_meal_plan_Meal Plan 3': 0, 'type_of_meal_plan_Not Selected': 0,
        'room_type_reserved_Room_Type 1': 0, 'room_type_reserved_Room_Type 2': 1,
        'room_type_reserved_Room_Type 3': 0, 'room_type_reserved_Room_Type 4': 0,
        'room_type_reserved_Room_Type 5': 0, 'room_type_reserved_Room_Type 6': 0,
        'room_type_reserved_Room_Type 7': 0,
        'market_segment_type_Aviation': 0, 'market_segment_type_Complementary': 0,
