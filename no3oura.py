...
def predict_booking_status(no_of_adults, no_of_children, no_of_weekend_nights, no_of_week_nights,
    ...
    meal_encoded = label_encoders['type_of_meal_plan'].transform([[type_of_meal_plan]])
    room_encoded = label_encoders['room_type_reserved'].transform([[room_type_reserved]])
    market_encoded = label_encoders['market_segment_type'].transform([[market_segment_type]])
